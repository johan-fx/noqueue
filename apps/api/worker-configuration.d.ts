/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareBindings` (hash: 454195538545de78e0e694396b49d83c)
...
interface __BaseEnv_CloudflareBindings {
	...
	CONFIRMATION_EXPERIMENT_ENABLED: string;
	STAGING_EXPERIMENT_APPROVED: string;
	STAGING_EXPERIMENT_OPEN_RECIPIENTS: string;
	PUBLIC_APP_ORIGIN: string;
	WHATSAPP_QUEUE_JOINED_TEMPLATE_ES: string;
	WHATSAPP_QUEUE_JOINED_TEMPLATE_EN: string;
	D360DIALOG_REQUEST_TIMEOUT_MS: string;
	STAGING_CONSENT_APPROVED: string;
	APP_ENV: string;
	D360DIALOG_PHONE_NUMBER_ID: string;
	QUEUE_COORDINATOR: DurableObjectNamespace<import("./src/index").QueueCoordinator>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QueueCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WHATSAPP_MODE" | "WHATSAPP_ENABLED" | "CONFIRMATION_EXPERIMENT_ENABLED" | "STAGING_EXPERIMENT_APPROVED" | "STAGING_EXPERIMENT_OPEN_RECIPIENTS" | "PUBLIC_APP_ORIGIN" | "WHATSAPP_QUEUE_JOINED_TEMPLATE_ES" | "WHATSAPP_QUEUE_JOINED_TEMPLATE_EN" | "D360DIALOG_REQUEST_TIMEOUT_MS" | "STAGING_CONSENT_APPROVED" | "APP_ENV" | "D360DIALOG_PHONE_NUMBER_ID">> {}
}
